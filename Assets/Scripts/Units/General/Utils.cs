...
public class Utils
{
  ...
  public static List<GameObject> getEnemiesInRange(Vector3 targetPosition, float range)
  {
    return getTaggedObjectsInRange(targetPosition, range, "Enemy");
  }

  public static List<GameObject> getAlliesInRange(Vector3 targetPosition, float range)
  {
